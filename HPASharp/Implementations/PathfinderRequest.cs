 ...
 * @author davebaol */
	public class PathFinderRequest<N>
	{
		...
		public const int SEARCH_NEW = 0;
		public const int SEARCH_INITIALIZED = 1;
		public const int SEARCH_DONE = 2;
		public const int SEARCH_FINALIZED = 3;

		public N startNode;
		public N endNode;
		public IHeuristic<N> heuristic;
		public IGraphPath<N> resultPath;
		 ...
		 * {@link MessageManager}. */
		public PathFinderRequest(N startNode, N endNode, IHeuristic<N> heuristic, IGraphPath<N> resultPath) :
		...
		public PathFinderRequest(N startNode, N endNode, IHeuristic<N> heuristic, IGraphPath<N> resultPath, MessageDispatcher dispatcher)
		{
		...
		public bool initializeSearch(long timeToRun)
		{
			return true;
		}
		...
		public bool search(IPathFinder<N> pathFinder, long timeToRun)
		{
		...
		public bool finalizeSearch(long timeToRun)
		{
			return true;
		}
	}
